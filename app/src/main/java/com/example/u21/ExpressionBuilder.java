...
import com.example.u21.function.Function;
import com.example.u21.function.Functions;
import com.example.u21.operator.Operator;
import com.example.u21.shuntingyard.ShuntingYard;
...
public class ExpressionBuilder {
    ...
    /**
     * Add a {@link com.example.u21.function.Function} implementation available for use in the expression
     *
     * @param function the custom {@link com.example.u21.function.Function} implementation that should be available for use in the expression.
    ...
    /**
     * Add multiple {@link com.example.u21.function.Function} implementations available for use in the expression
     *
     * @param functions the custom {@link com.example.u21.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
     ...
     * Add multiple {@link com.example.u21.function.Function} implementations available for use in the expression
     *
     * @param functions A {@link List} of custom {@link com.example.u21.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add an {@link com.example.u21.operator.Operator} which should be available for use in the expression
     *
     * @param operator the custom {@link com.example.u21.operator.Operator} to add
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add multiple {@link com.example.u21.operator.Operator} implementations which should be available for use in the expression
     *
     * @param operators the set of custom {@link com.example.u21.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
     ...
     * Add multiple {@link com.example.u21.operator.Operator} implementations which should be available for use in the expression
     *
     * @param operators the {@link List} of custom {@link com.example.u21.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
